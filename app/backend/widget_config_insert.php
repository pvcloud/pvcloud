...
/* * *
 *  http://localhost:8080/pvcloud_backend/widget_config_insert.php
 * 
 * * */
...
class Post {
    ...
    public static function insertGetWidgetConfig() {
        $response = new simpleResponse();
        include './inc/incWebServiceSessionValidation.php';
       
        try {
             $parameters = Post::collectParameters();
             $widgetConfig = da_widget_config::InsertWidgetConfig($parameters->widget);
             $response->status = "OK";
             $response->message = "";
...
echo json_encode(Post::insertGetWidgetConfig());
